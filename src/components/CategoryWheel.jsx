...
const getColorFromClass = (colorClass) => {
    ...
    return colorMap[colorClass] || colorMap['bg-purple-600'];
};
...
const CategoryWheel = ({ difficulty = 'principiante', onCategorySelected = () => { } }) => {
    ...
    return (
        <div className="flex flex-col items-center justify-center p-4 md:p-6">
            <div className="relative w-full max-w-[500px] h-full max-h-[500px] mx-auto">
                ...
                <div className="absolute inset-x-0 top-0 flex justify-center -translate-y-4 z-20">
                    <div className="w-0 h-0 border-l-6 border-r-6 border-b-10 border-solid border-transparent border-b-purple-600"></div>
                </div>
