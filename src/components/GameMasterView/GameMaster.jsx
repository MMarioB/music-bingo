  ...
  return (
    <GameLayout roomCode={roomCode} playersCount={connectedPlayers.length}>
      {serverWaking && connectionError ? (
        <Alert className="mb-4 bg-cyan-500/20 border border-cyan-500/50"><AlertCircle className="h-4 w-4 text-cyan-300" /><AlertDescription className="text-cyan-200">{connectionError}</AlertDescription></Alert>
      ) : connectionError ? (
        <Alert variant="destructive" className="mb-4 bg-red-500/20 border border-red-500/50"><AlertCircle className="h-4 w-4 text-white" /><AlertDescription className="text-white">{connectionError}</AlertDescription></Alert>
      ) : null}
