      ...
      <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-lg p-3 space-y-3">
        ...
        {logic.currentSong && !logic.currentSong.revealed && (
          <div className="space-y-2">
            {logic.currentSong.spotifyUrl && (
              <Button
                className="w-full h-10 bg-green-600 hover:bg-green-700 text-white font-bold text-sm border-2 border-green-400/50"
                onClick={() => window.open(logic.currentSong.spotifyUrl, '_blank')}
              >
