...
function App() {
  ...
  const renderNameInput = () => (
    <Card className="w-full max-w-md p-8 bg-black/40 shadow-2xl backdrop-blur-sm border border-white/10">
  ...
  const renderMainContent = () => {
    ...
    if (gameState.phase === 'role-selection') {
      return (
        <div className="w-full min-h-screen bg-[#1a0133] p-4 relative">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center min-h-screen">
            {/* Título principal (solo en la pantalla inicial) */}
            <motion.div
    ...
    // Para el resto de las pantallas, usamos GameLayout
    return (
      <GameLayout
        roomCode={gameState.roomCode}
        playersCount={0} // Esto debería actualizarse con el número real de jugadores
        showSelect={gameState.selectedRole === 'master'}
        selectContent={null} // Añadir el contenido del select cuando sea necesario
      >
